...
@Component({
  selector: 'app-artisan-edit-invoice-item',
  imports: [EditInvoiceItemComponent],
  templateUrl: './artisan-edit-invoice-item.component.html',
  styleUrl: './artisan-edit-invoice-item.component.css'
})
export class ArtisanEditInvoiceItemComponent {
